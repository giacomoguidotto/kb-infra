...
`skills/setup/SKILL.md` and follow it. It connects the KB provider, collects
...
- `setup` (`skills/setup/`): materialize the infra.

When a skill is edited, re-run `setup`'s install step to re-copy it into the
