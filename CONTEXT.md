...
**Social Draft Pulse**: A scheduled lookup-to-social-draft workflow that turns recent public-safe KB context into approved drafts in the social draft queue sink. It drafts a content mix of project/proof and topical posts, keeps per-platform continuity through the published social context surface, grounds topical angles in the point-of-view surface, and recommends a posting slot and slot-matched tone for each draft from the schedule in social rules of engagement. It first-party-captures a point-of-view take stated at the gate and the published-social-context ledger (both public-facing, via explicit-consent `/capture`), but never posts, schedules, branches, or publishes.
